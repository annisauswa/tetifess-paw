...
export default function Sidebar() {
    ...
    return (
      <section className="flex flex-col h-full bg-secondary border-tertiary border-r-[1px] px-[60px] py-[40px] gap-[4px] justify-between">
        <div>
          {menu.map((item, idx) => {
            ...
            return (
              <Link href={item.href} key={idx}>
                <button
                  className={`w-full flex gap-[16px] hover:bg-tertiary/20 p-[12px] rounded-[24px] text-black items-center justify-start ${
